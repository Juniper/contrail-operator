...
func (r *ReconcileSwiftProxy) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	svc := r.kubernetes.Service(request.Name+"-swiftproxy", core.ServiceTypeLoadBalancer, servicePortsMap, contrail.SwiftProxyInstanceType, swiftProxy, core.ProtocolTCP)
