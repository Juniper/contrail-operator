...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileFernetKeyManager{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner FernetKeyManager
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &contrailv1alpha1.FernetKeyManager{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileFernetKeyManager) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Fetch the FernetKeyManager instance
	instance := &contrailv1alpha1.FernetKeyManager{}
	...
	// Set FernetKeyManager instance as the owner and controller
...
func newPodForCR(cr *contrailv1alpha1.FernetKeyManager) *corev1.Pod {
