		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"swiftStorage": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/contrail/v1alpha1.SwiftStorage"),
						},
					},
				},
			},
