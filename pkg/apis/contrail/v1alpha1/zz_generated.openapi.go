...
func schema_pkg_apis_contrail_v1alpha1_ContrailCommand(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("atom/atom/contrail/operator/pkg/apis/contrail/v1alpha1.ContrailCommandSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("atom/atom/contrail/operator/pkg/apis/contrail/v1alpha1.ContrailCommandStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"atom/atom/contrail/operator/pkg/apis/contrail/v1alpha1.ContrailCommandSpec", "atom/atom/contrail/operator/pkg/apis/contrail/v1alpha1.ContrailCommandStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_contrail_v1alpha1_ContrailCommandSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"serviceConfiguration": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("atom/atom/contrail/operator/pkg/apis/contrail/v1alpha1.ContrailCommandConfiguration"),
						},
					},
				},
				Required: []string{"commonConfiguration", "serviceConfiguration"},
		...
		Dependencies: []string{
			"atom/atom/contrail/operator/pkg/apis/contrail/v1alpha1.CommonConfiguration", "atom/atom/contrail/operator/pkg/apis/contrail/v1alpha1.ContrailCommandConfiguration"},
	}
}
...
func schema_pkg_apis_contrail_v1alpha1_Services(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"contrailCommand": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("atom/atom/contrail/operator/pkg/apis/contrail/v1alpha1.ContrailCommand"),
						},
					},
					"postgreses": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/zalando/postgres-operator/pkg/apis/acid.zalan.do/v1.Postgresql"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/Juniper/contrail-operator/pkg/apis/contrail/v1alpha1.Cassandra", "github.com/Juniper/contrail-operator/pkg/apis/contrail/v1alpha1.Config", "github.com/Juniper/contrail-operator/pkg/apis/contrail/v1alpha1.Control", "github.com/Juniper/contrail-operator/pkg/apis/contrail/v1alpha1.Kubemanager", "github.com/Juniper/contrail-operator/pkg/apis/contrail/v1alpha1.Rabbitmq", "github.com/Juniper/contrail-operator/pkg/apis/contrail/v1alpha1.Vrouter", "github.com/Juniper/contrail-operator/pkg/apis/contrail/v1alpha1.Webui", "github.com/Juniper/contrail-operator/pkg/apis/contrail/v1alpha1.Zookeeper"},
	}
}
