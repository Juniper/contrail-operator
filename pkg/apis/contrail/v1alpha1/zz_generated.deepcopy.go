...
func (in *KubemanagerStaticConfiguration) DeepCopyInto(out *KubemanagerStaticConfiguration) {
	*out = *in
	if in.ConfigNodes != nil {
		in, out := &in.ConfigNodes, &out.ConfigNodes
		*out = new(ServerNodes)
		(*in).DeepCopyInto(*out)
	}
	if in.RabbbitmqNodes != nil {
		in, out := &in.RabbbitmqNodes, &out.RabbbitmqNodes
		*out = new(ServerNodes)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.ZookeeperNodes != nil {
		in, out := &in.ZookeeperNodes, &out.ZookeeperNodes
		*out = new(ServerNodes)
		(*in).DeepCopyInto(*out)
	}
	return
