...
// ContrailmonitorConfiguration is the Spec for the ContrailMonitorStatus API.
...
type ContrailmonitorStatus struct {
	...
	Postgres         *ModuleStatus   `json:"postgres,omitempty"`
	Config           []*ModuleStatus `json:"config,omitempty"`
	Webui            []*ModuleStatus `json:"webui,omitempty"`
	Cassandras       *ModuleStatus   `json:"cassandras,omitempty"`
	Zookeepers       *ModuleStatus   `json:"zookeepers,omitempty"`
	Rabbitmq         *ModuleStatus   `json:"rabbitmq,omitempty"`
	ProvisionManager *ModuleStatus   `json:"provisionManager,omitempty"`
	Keystone         *ModuleStatus   `json:"keystone,omitempty"`
	Memcached        *ModuleStatus   `json:"memcached,omitempty"`
}
