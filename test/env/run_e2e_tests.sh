...
go test -v ./test/e2e/$E2E_TEST_SUITE/... -run=TestHACommand -namespacedMan test/env/deploy/empty.yaml -globalMan test/env/deploy/empty.yaml -root $DIR -parallel=8 -skipCleanupOnError=false $TEST_CONFIGURATION
