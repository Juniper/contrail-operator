...
contrail-nightly/contrail-command:master.1412
contrail-nightly/contrail-controller-config-api:master.1412
contrail-nightly/contrail-controller-config-devicemgr:master.1412
contrail-nightly/contrail-controller-config-schema:master.1412
contrail-nightly/contrail-controller-config-svcmonitor:master.1412
contrail-nightly/contrail-controller-control-control:master.1412
contrail-nightly/contrail-controller-control-dns:master.1412
contrail-nightly/contrail-controller-control-named:master.1412
contrail-nightly/contrail-controller-webui-job:master.1412
contrail-nightly/contrail-controller-webui-web:master.1412
contrail-nightly/contrail-kubernetes-kube-manager:master.1412
contrail-nightly/contrail-kubernetes-cni-init:master.1412
contrail-nightly/contrail-node-init:master.1412
contrail-nightly/contrail-nodemgr:master.1412
contrail-nightly/contrail-controller-config-dnsmasq:master.1412
contrail-nightly/contrail-analytics-api:master.1412
contrail-nightly/contrail-analytics-collector:master.1412
contrail-nightly/contrail-analytics-query-engine:master.1412
contrail-nightly/contrail-controller-config-devicemgr:master.1412
