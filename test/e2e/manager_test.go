					...
					Spec: v1alpha1.ConfigSpec{
						...
						ServiceConfiguration: v1alpha1.ConfigConfiguration{
							...
							Containers: map[string]*v1alpha1.Container{
								...
								"devicemanager":     &v1alpha1.Container{Image: "registry:5000/contrail-controller-config-devicemgr:dev"}, // Using custom dev version until required changes are merged upstream
