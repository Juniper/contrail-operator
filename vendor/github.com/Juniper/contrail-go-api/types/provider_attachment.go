...
func (obj *ProviderAttachment) readTagRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[provider_attachment_tag_refs] {
...
func (obj *ProviderAttachment) AddTag(
        ...
        if !obj.modified[provider_attachment_tag_refs] {
        ...
        obj.modified[provider_attachment_tag_refs] = true
        return nil
}
...
func (obj *ProviderAttachment) ClearTag() {
        if obj.valid[provider_attachment_tag_refs] &&
           !obj.modified[provider_attachment_tag_refs] {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
        obj.tag_refs = make([]contrail.Reference, 0)
        obj.valid[provider_attachment_tag_refs] = true
        obj.modified[provider_attachment_tag_refs] = true
}
