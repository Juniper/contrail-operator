...
const (
	...
	virtual_network_virtual_network_routed_properties
...
type VirtualNetwork struct {
	...
	virtual_network_routed_properties   VirtualNetworkRoutedPropertiesType
...
func (obj *VirtualNetwork) GetVirtualNetworkRoutedProperties() VirtualNetworkRoutedPropertiesType {
	return obj.virtual_network_routed_properties
}

func (obj *VirtualNetwork) SetVirtualNetworkRoutedProperties(value *VirtualNetworkRoutedPropertiesType) {
	obj.virtual_network_routed_properties = *value
	obj.modified[virtual_network_virtual_network_routed_properties] = true
}
...
func (obj *VirtualNetwork) MarshalJSON() ([]byte, error) {
	...
	if obj.modified[virtual_network_virtual_network_routed_properties] {
		var value json.RawMessage
		value, err := json.Marshal(&obj.virtual_network_routed_properties)
		if err != nil {
			return nil, err
		}
		msg["virtual_network_routed_properties"] = &value
	}
...
func (obj *VirtualNetwork) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "virtual_network_properties":
			...
			break
		case "virtual_network_routed_properties":
			err = json.Unmarshal(value, &obj.virtual_network_routed_properties)
			if err == nil {
				obj.valid[virtual_network_virtual_network_routed_properties] = true
			}
			break
