...
func (obj *Subnet) AddTag(
	...
	if !obj.modified[subnet_tag_refs] {
	...
	obj.modified[subnet_tag_refs] = true
	return nil
}
...
func (obj *Subnet) ClearTag() {
	if obj.valid[subnet_tag_refs] &&
		!obj.modified[subnet_tag_refs] {
		obj.storeReferenceBase("tag", obj.tag_refs)
	}
	obj.tag_refs = make([]contrail.Reference, 0)
	obj.valid[subnet_tag_refs] = true
	obj.modified[subnet_tag_refs] = true
}
