...
const (
	...
	virtual_port_group_virtual_port_group_type
	...
	virtual_port_group_security_group_refs
	virtual_port_group_port_profile_refs
...
type VirtualPortGroup struct {
	...
	virtual_port_group_type string
...
func (obj *VirtualPortGroup) GetVirtualPortGroupType() string {
        return obj.virtual_port_group_type
}

func (obj *VirtualPortGroup) SetVirtualPortGroupType(value string) {
        obj.virtual_port_group_type = value
        obj.modified[virtual_port_group_virtual_port_group_type] = true
}
...
func (obj *VirtualPortGroup) readSecurityGroupRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[virtual_port_group_security_group_refs] {
...
func (obj *VirtualPortGroup) AddSecurityGroup(
        ...
        if !obj.modified[virtual_port_group_security_group_refs] {
        ...
        obj.modified[virtual_port_group_security_group_refs] = true
        return nil
}
...
func (obj *VirtualPortGroup) ClearSecurityGroup() {
        if obj.valid[virtual_port_group_security_group_refs] &&
           !obj.modified[virtual_port_group_security_group_refs] {
                obj.storeReferenceBase("security-group", obj.security_group_refs)
        }
        obj.security_group_refs = make([]contrail.Reference, 0)
        obj.valid[virtual_port_group_security_group_refs] = true
        obj.modified[virtual_port_group_security_group_refs] = true
}
...
func (obj *VirtualPortGroup) readPortProfileRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[virtual_port_group_port_profile_refs] {
...
func (obj *VirtualPortGroup) AddPortProfile(
        ...
        if !obj.modified[virtual_port_group_port_profile_refs] {
        ...
        obj.modified[virtual_port_group_port_profile_refs] = true
        return nil
}
...
func (obj *VirtualPortGroup) ClearPortProfile() {
        if obj.valid[virtual_port_group_port_profile_refs] &&
           !obj.modified[virtual_port_group_port_profile_refs] {
                obj.storeReferenceBase("port-profile", obj.port_profile_refs)
        }
        obj.port_profile_refs = make([]contrail.Reference, 0)
        obj.valid[virtual_port_group_port_profile_refs] = true
        obj.modified[virtual_port_group_port_profile_refs] = true
}
...
func (obj *VirtualPortGroup) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[virtual_port_group_virtual_port_group_type] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.virtual_port_group_type)
                if err != nil {
                        return nil, err
                }
                msg["virtual_port_group_type"] = &value
        }
...
func (obj *VirtualPortGroup) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "virtual_port_group_user_created":
                        ...
                        break
                case "virtual_port_group_type":
                        err = json.Unmarshal(value, &obj.virtual_port_group_type)
                        if err == nil {
                                obj.valid[virtual_port_group_virtual_port_group_type] = true
                        }
                        break
                case "id_perms":
