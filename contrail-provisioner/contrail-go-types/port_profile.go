...
const (
	...
	port_profile_virtual_port_group_back_refs
	port_profile_max_
)
...
func (obj *PortProfile) readVirtualPortGroupBackRefs() error {
	if !obj.IsTransient() &&
		!obj.valid[port_profile_virtual_port_group_back_refs] {
...
func (obj *PortProfile) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "virtual_port_group_back_refs":
			...
			if err == nil {
				obj.valid[port_profile_virtual_port_group_back_refs] = true
			}
			break
		}
		if err != nil {
