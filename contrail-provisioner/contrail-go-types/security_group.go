...
const (
	...
	security_group_virtual_port_group_back_refs
	security_group_max_
)
...
func (obj *SecurityGroup) readVirtualPortGroupBackRefs() error {
	if !obj.IsTransient() &&
		!obj.valid[security_group_virtual_port_group_back_refs] {
...
func (obj *SecurityGroup) UnmarshalJSON(body []byte) error {
	...
	for key, value := range m {
		...
		case "virtual_port_group_back_refs":
			...
			if err == nil {
				obj.valid[security_group_virtual_port_group_back_refs] = true
			}
			break
